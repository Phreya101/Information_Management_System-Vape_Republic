...
<body>
    ...
    <img src="../../../../img/logo.jpg" alt="Logo" width="150" height="150"
        class=" rounded-circle mt-2 mx-auto d-block mt-5">
    <p class="mt-2 text-center">
        <span class="text-center text-uppercase fw-bold mb-5 h1 daily">Daily Inventory</span><br><br>
        <span class="text-center text-uppercase fw-bold mb-5 h3">Disposable</span>
    </p>
